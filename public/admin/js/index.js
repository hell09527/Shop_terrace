...
$(function(){
	...
	onloadKolBalanceWithdrawCount();//极选师申请审核中
 ...
 * 加载极选师审核中的数量
 */
function onloadKolBalanceWithdrawCount(){
	$.ajax({
		type : 'post',
		url : __URL(ADMINMAIN + "/index/getKolBalanceWithdrawCount"),
		success : function(data){
			exeryTimePut("kol_send_withdraw", data);
		}
	});
}
