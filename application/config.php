...
define('ADMIN_MODULE', "dira"); // 重新定义后台模块
...
return [
    ...
    'app_debug' => \think\Env::get('app.env') == 'dev' ? true : false,
    // 应用Trace
    'app_trace' => false,
    // 应用模式状态
    'app_status' => '',
    ...
    // 错误显示信息,非调试模式有效
    'error_message' => '页面不存在或者系统正忙，请稍后再试或联系IT!',
    // 显示错误信息
...
//    ],
    ...
    'view_replace_str' => array(
        ...
        'UPLOAD_OFFLINE_PAY' => UPLOAD . '/offlinepay/', // 线下支付
