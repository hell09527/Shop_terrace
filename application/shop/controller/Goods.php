...
class Goods extends BaseController
{
    ...
    public function goodsList()
    {
        ...
        if (empty($goods_sales_list_cache)) {
            ...
            $goods_sales_list = $goods_new_list_cache;
        }
    ...
    public function integralCenter()
    {
        ...
        $page_count = 25;
        $hotGoods = $this->goods->getGoodsQueryLimit($condition, "ng.goods_id,ng.goods_name,ng.point_exchange,ng_sap.pic_cover_mid", 4);
    ...
    public function cart()
    {
        ...
        if (count($cart_list[0]["goods_id_array"]) > 0) {
            foreach ($cart_list[0]["goods_id_array"] as $v) {
    ...
    public function couponList()
    {
        ...
        $uid = $this->uid;
        $promotion_list = $promotion_service->getCouponTypeInfoList($page_index, 6, $condition, '', $uid);
        ...
        if (request()->isAjax()) {
            return view($this->style . 'Goods/controlColumnSelectionList');
        }
        return view($this->style . 'Goods/controlColumnSelectionList');
    }
     ...
     * 栏目精选1
     */
    public function controlColumnSelection1()
    {

        return view($this->style . "Goods/controlColumnSelection1");
    }

    /**
     * 栏目精选2
     */
    public function controlColumnSelection2()
    {

        return view($this->style . "Goods/controlColumnSelection2");
    }
    /**
     * 栏目精选3
     */
    public function controlColumnSelection3()
    {

        return view($this->style . "Goods/controlColumnSelection3");
    }
    /**
     * 栏目精选4
     */
    public function controlColumnSelection4()
    {

        return view($this->style . "Goods/controlColumnSelection4");
    }
    /**
     * 栏目精选5
     */
    public function controlColumnSelection5()
    {

        return view($this->style . "Goods/controlColumnSelection5");
    }
    /**
     * 栏目精选6
     */
    public function controlColumnSelection6()
    {

        return view($this->style . "Goods/controlColumnSelection6");
    }
    /**
     * 栏目精选7
     */
    public function controlColumnSelection7()
    {

        return view($this->style . "Goods/controlColumnSelection7");
    }
    /**
     * 栏目精选8
     */
    public function controlColumnSelection8()
    {

        return view($this->style . "Goods/controlColumnSelection8");
    }
    /**
     * 栏目精选9
     */
    public function controlColumnSelection9()
    {

        return view($this->style . "Goods/controlColumnSelection9");
    }
}