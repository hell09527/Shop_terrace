...
// 存放支付凭证图片
define("UPLOAD_OFFLINE_PAY", Config::get('view_replace_str.UPLOAD_OFFLINE_PAY'));
...
class Upload extends Controller
{
     ...
     * 用于相册多图上传
     *
     * @return string|multitype:string number, \think\false, string>
     */
