...
interface IPromotion
{
     ...
     * @param $end_time
     * @param $is_show
     * @param $is_show_detail
     * @param $goods_list
     * @param $send_type
     * @param $limit_repeated_use
     * @param $use_type
     * @param $get_after_days
     * @param $pay_money_get
     * @return mixed
     * 添加优惠券类型
     */
    function addCouponType($coupon_name, $money, $count, $max_fetch, $at_least, $need_user_level, $range_type, $start_time, $end_time, $is_show, $is_show_detail, $goods_list,$send_type, $limit_repeated_use, $use_type, $get_after_days,$pay_money_get);
     ...
     * 修改优惠券类型
     */
    function updateCouponType($coupon_id, $coupon_name, $money, $count, $repair_count, $max_fetch, $at_least, $need_user_level, $range_type, $start_time, $end_time, $is_show, $is_show_detail, $goods_list,$send_type, $limit_repeated_use, $use_type, $get_after_days,$pay_money_get);
     ...
     */
    function addPromotionGift($shop_id, $gift_name, $gift_num, $start_time, $end_time, $days, $max_num, $goods_id);
     ...
     */
    function updatePromotionGift($gift_id, $shop_id, $gift_name, $gift_num, $start_time, $end_time, $days, $max_num, $goods_id_array);
     ...
     * @param unknown $goods_id_array            
     * @param unknown $is_neigou
     */
    function addPromotionMansong($mansong_name, $start_time, $end_time, $shop_id, $remark, $type, $range_type, $rule, $goods_id_array , $is_neigou);
     ...
     * @param unknown $is_neigou
     */
    function updatePromotionMansong($mansong_id, $mansong_name, $start_time, $end_time, $shop_id, $remark, $type, $range_type, $rule, $goods_id_array , $is_neigou);
