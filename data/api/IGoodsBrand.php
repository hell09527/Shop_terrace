...
interface IGoodsBrand
{
     ...
     */
    function addOrUpdateGoodsBrand($brand_id, $shop_id, $brand_name, $brand_initial, $brand_class, $brand_pic, $brand_recommend, $sort, $brand_category_name = '', $category_id_array = '', $brand_ads, $brand_other_ads, $category_name, $category_id_1, $category_id_2, $category_id_3,$brand_video_address);
