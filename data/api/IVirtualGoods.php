...
interface IVirtualGoods
{
     ...
     * @param 创建时间 $create_time            
     */
    function addVirtualGoods($shop_id, $virtual_goods_name, $money, $buyer_id, $buyer_nickname, $order_goods_id, $order_no, $validity_period, $start_time, $end_time, $use_number, $confine_use_number, $use_status, $goods_id);
