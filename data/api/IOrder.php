...
interface IOrder
{
     ...
     */
    function orderCreate($order_type, $out_trade_no, $pay_type, $shipping_type, $order_from, $buyer_ip, $buyer_message, $buyer_invoice, $shipping_time, $receiver_mobile, $receiver_province, $receiver_city, $receiver_district, $receiver_address, $receiver_zip, $receiver_name, $point, $coupon_id, $user_money, $goods_sku_list, $platform_money, $pick_up_id, $shipping_company_id, $tx_type, $is_inside, $card_name, $card_no, $store_id, $source_distribution, $parent_source_distribution, $inviter, $from_type, $distributor_type, $traffic_acquisition_source, $count_money, $coin = 0, $fixed_telephone = "");

    function vipGetGoodsOrder($order_type, $out_trade_no, $receiver_mobile, $receiver_province, $receiver_city, $receiver_district, $receiver_address, $receiver_zip, $receiver_name, $goods_id, $source_branch);
    /**
     * 订单物流发货
     *
     * @param unknown $order_id            
    ...
    function orderGoodsRefundAskfors($order_id, $order_goods_id, $refund_type, $refund_require_money, $refund_require_num, $refund_reason);
     ...
     * @param unknown $uid            
     */
    function deleteBox($gooods_sku_list, $uid);
