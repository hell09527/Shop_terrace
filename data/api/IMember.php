...
interface IMember extends IUser
{
     ...
     */
    function registerMember($user_name, $password, $email, $mobile, $user_qq_id, $qq_info, $wx_openid, $wx_info, $wx_unionid, $source_branch, $traffic_acquisition_source);
    ...
    function addMemberLevel($shop_id, $level_name, $goods_discount, $desc);
    ...
    function updateMemberLevel($level_id, $shop_id, $level_name,$goods_discount, $desc);
