...
interface IGoods
{
     ...
     * @param unknown $condition
     */
    function getPromotionGoodsList($page_index = 1, $page_size = 0, $condition = '', $order = '', $field = '*');
     ...
     * @param unknown $bl_id            
     */
    function addBox($uid, $shop_id, $shop_name, $goods_id, $goods_name, $sku_id, $sku_name, $price, $num, $picture);
     ...
     * @param unknown $num            
     */
    function boxAdjustNum($box_id, $num);
    
    
    /**
     * 礼品盒项目删除
     *
     * @param unknown $box_id_array
     *            多项用，隔开
     */
    function boxDelete($box_id_array);
