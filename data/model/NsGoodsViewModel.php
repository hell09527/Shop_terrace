...
class NsGoodsViewModel extends BaseModel {
    ...
    public function getGoodsViewQuery($page_index, $page_size, $condition, $order)
    {
        ...
        ->field('ng.goods_id, ng.goods_name, ng.source_type, ng.material_code, ng.shop_id, ng.category_id, ng.brand_id, ng.group_id_array,
            ...
            ng.update_time, ng.sort, ng.real_sales, ngb.brand_name, ngb.brand_pic, ngc.category_id, ngc.category_name, sap.pic_cover_micro,sap.pic_cover_mid,sap.pic_cover_small,nss.shop_name,nss.shop_type,sap.pic_id,sap.upload_type, sap.domain, sap.bucket ,ng.fraction ,ng.sale_type ,ng.sale_end_time ,ng.delivery_end_time');
