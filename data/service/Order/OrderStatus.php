...
//                    )
     ...
     * 获取极选师的账户明细类型
     */
    public static function getDistributorAccountRecordsType()
    {
        $status = array(
            array(
                'type_id' => '1',
     ...
     * 获取极选师的订单状态
     */
    public static function getKolOrderCommonStatus()
    {
        $status = array(
            array(
                'status_id' => '1',
     ...
     * 获取会员订单所有可能的订单状态
     */
    public static function getVipOrderCommonStatus()
    {
        $status = array(
            array(
                'status_id' => '0',
    ...
    /*
     * 获取礼品订单所有可能的订单状态（0：待付款；11：待领取；1：已领取；2：已发货；3：已收货；4：已完成；5：已关闭；-1：退款中；-2：已退款）
     */
    public static function getGiftOrderCommonStatus()
    {
        $status = array(
            array(
                'status_id' => '0',
