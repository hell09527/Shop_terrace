...
class VirtualGoods extends BaseService implements IVirtualGoods
{
    ...
    public function editVirtualGoodsType($virtual_goods_type_id, $virtual_goods_group_id, $virtual_goods_type_name, $validity_period, $is_enabled, $money, $config_info, $confine_use_number)
    {
        ...
        if ($virtual_goods_type_id == 0) {
            ...
            $data = array(
                ...
                'validity_period' => getTimeTurnTimeStamp($validity_period),
     ...
     */
    public function addVirtualGoods($shop_id, $virtual_goods_name, $money, $buyer_id, $buyer_nickname, $order_goods_id, $order_no, $validity_period, $start_time, $end_time, $use_number, $confine_use_number, $use_status, $goods_id)
    {
...
//         }
    ...
    function getVirtualGoodsList($page_index, $page_size, $condition, $order = "")
    {
        ...
        foreach($list["data"] as $k => $v){
            ...
            $picture_info = $album_picture -> getInfo(["pic_id" => $v["picture"]], "pic_cover_mid");
            $picture_info_src = '';
